...
plt.title("Top 50 błędów: Predykcje vs Rzeczywiste - Regresja Ridge", fontsize=12)
...
plt.legend()
plt.tight_layout()
plt.savefig("../../plots/predicts/errors_over_time_Ridge_full_stable_period.png", dpi=300)
plt.close()
